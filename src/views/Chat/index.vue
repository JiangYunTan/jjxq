<template>
  <div class="container">
    ...
    <div class="chat-list">
      <div v-for="obj, index in list" :key="index">
          ...
          <div class="chat-item left" v-if="obj.name === 'xs'">
            <van-image fit="cover" round src="https://img2.woyaogexing.com/2021/08/30/bfe0743d022246449bceabdbdcbb609f!400x400.jpeg" />
    ...
    <div class="reply-container van-hairline--top">
      <van-field  placeholder="说点什么..." v-model="word" @keydown.enter="sendFn">
        <template #button>
...
export default {
  ...
  methods: {
    ...
    async fn () {
      ...
      // console.log(this.$store.state.user.user.photo);
    }
  },
  created () {
    // ...
